			...
			<div class="sandbox">
				...
				<?php 
                    ...
                    if ($species == "Black Rhino") {
                        ...
                        echo "<p>Welcome, Black Rhino! You and the other rhinos will love this big lake.</p>";
                ...
                <?php 
                    ...
                    if ($yearsOnEarth == 40) {
                        ...
                        echo "<p>Congratualtions for being on Earth for 40 years!</p>";
                        
                    } elseif ($yearsOnEarth < 40) {
                        
                        echo "<p>Not quite 40 yet, young person.</p>";
                        
                    } else {
                        
                        echo "<p>You must be more than 40 years old.</p>";                        
                    }               
                ?>
