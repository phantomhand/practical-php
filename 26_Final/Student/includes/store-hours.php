...
$open_now = "<strong class='open'>Yes, we're open!<br><br> Today's hours are:<br> %open% - %closed%.</strong>";
$closed_now = "<strong class='closed'>Sorry, we're closed.<br><br> Today's hours are:<br> %open% - %closed%.</strong>";
